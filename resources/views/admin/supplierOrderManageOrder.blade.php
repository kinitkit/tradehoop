...
@section('page', 'Current Order') 
@section('content')

<div class="space50">
    <div>
        <a href="/adminsupplierorder" class="btn btn-warning">&emsp;Back&emsp;</a>
            ...
            <div class="col-md-6">
                <form id="form-admin-details" class="form-horizontal" method="post" action="adminsupplierordermanagedetailsupdatestatus">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input value="{{isset($supplierorder->datedelivery) ? date('Y-m-d', strtotime($supplierorder->datedelivery)) : ''}}" type="date" name="datedelivery" id="datedelivery"
                                class="form-control" min="{{$supplierorder->dateMin}}" max="{{$supplierorder->dateMax}}" <?php
                                echo $isOrderDetailsReadOnly ? "disabled" : "required"; ?> />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="hidden" value="2" id="inpstatustype" name="inpstatustype" class="form-control" readonly/>
                    </div>
                    <div class="form-group">
...
<div style="margin: 10px;">
    ...
    <h3>Order Details</h3>
    <p>(List of items that will be delivered)</p>
            ...
            foreach($supplierorderdetailsitemview as $s){
                echo "
                    <tr>
                        ...
                        <td>".$s->name."</td>
                        <td>".$s->unit."</td>
                        <form method='post' action='adminsupplierordermanageorderupdateqtyprovided'>
                            ".csrf_field()."
                            ...
                            <td>
                                <input style='width:100px' name='qtyprovided' type='number' min='0' value={$s->qtyprovided} ". ($isOrderDetailsReadOnly ? "readonly" : "")." />
                            </td>
                            <td>
